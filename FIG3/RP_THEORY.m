function RP_THEORY(PdB,QdB,LL,PL,RR,NN,xB,yB,xP,yP,xE,yE,eta,alpha)
% RP_THEORY  : Theory of Random Path Protocol
% OP: Outage Probability
OP = zeros(1, length(alpha));
%
for aa = 1 : length(alpha)
    OP(aa) = RPfunc(PdB,QdB,LL,PL,RR,NN,xB,yB,xP,yP,xE,yE,eta,alpha(aa));
end
%
OP
%
plot(alpha,OP,'g-'); grid on;hold on;
end
%
