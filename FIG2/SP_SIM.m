...
for aa = 1 : length(PP)
    ...
    for bitnum   =  1 : Num_Trial       
        ...
        SNRmin   = inf;
        for bb = 1 : Lmin
            % Parameter of data links: Lambda_D; 1/Lmin equals to distance between source to relay nodes,
            % and it equals to distance between relay nodes
            LD    = (1/Lmin)^PL;
            % Parameter of energy harvesting links: Lambda_B, links between
            % beacons and source, relay nodes
...
OP
%
plot(PdB,OP,'bs'); grid on;hold on;
end
